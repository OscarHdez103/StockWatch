...
st.markdown(
    '<div style="text-align: center;">StockWatch is a comprehensive dashboard that enables you to effortlessly track national-level and individual supermarket stock for various products.</div>',
